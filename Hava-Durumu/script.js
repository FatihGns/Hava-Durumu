...
function onSuccess(position){
    ...
    api = `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&units=metric&appid=6f95888048e2f79bbd9b58c59d052bef`;
    fetchData()
}
...
function requestApi(city){
    api = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=6f95888048e2f79bbd9b58c59d052bef`;
    fetchData()
}
